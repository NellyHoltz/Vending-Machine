...
with a list of all items in the vending machine with its quantity remaining:
    ...
    - Each slot in the vending machine has enough room for five of that product.
...
7. The purchase process flow is as follows:
    ...
    purchase.
        ...
        remaining. Dispensing also returns a message:
          - All chip items print "Crunchy Crunchy, Yum!"
          - All candy items print "Munch Munch, Yum!"
          - All drink items print "Slurp Slurp, Yum!"
          - All gum items print "Chewy Chewy, Yum!"
...
8. The vending machine logs all transactions to prevent theft from the vending machine.
   - Each purchase must generate a line in a file called `SalesLog.txt`.
   - The lines must follow the format shown in the following example.
       ...
       - The second dollar amount is the new balance.
        ```
        10/06/2022 12:00:00 PM FEED MONEY: $5.00 $5.00 
        10/06/2022 12:00:15 PM FEED MONEY: $5.00 $10.00 
        10/06/2022 12:00:20 PM Crunchie B4 $1.75 $8.25 
        10/06/2022 12:01:25 PM Cowtales B2 $1.50 $6.75 
        10/06/2022 12:01:35 PM GIVE CHANGE: $6.75 $0.00
        ```
